...
void insert(int element, int arr[], int *f, int *r, int mSize)
{
...
int main()
{
    ...
    insert(10, arr, &f, &r, mSize);
    insert(20, arr, &f, &r, mSize);
    insert(30, arr, &f, &r, mSize);
    insert(40, arr, &f, &r, mSize);
    insert(50, arr, &f, &r, mSize);
